    ...
    <>
      ...
      <main className="max-w-7xl mx-auto py-32 px-4 sm:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          {/* Project Card 1 */}
          <div className="bg-white/90 shadow-xl rounded-2xl overflow-hidden border border-green-100 hover:shadow-2xl transition-shadow duration-300 group hover:animate-card-pop">
        ...
        <div className="p-7">
          <h2 className="text-2xl font-bold mb-2 text-green-800 group-hover:text-green-600 transition-colors duration-300">E-Commerce Redesign</h2>
        ...
        <div className="p-7">
          <h2 className="text-2xl font-bold mb-2 text-green-800 group-hover:text-green-600 transition-colors duration-300">Startup Landing Page</h2>
          <p className="text-gray-700 group-hover:text-green-800 transition-colors duration-300">
        ...
        <div className="p-7">
          <h2 className="text-2xl font-bold mb-2 text-green-800 group-hover:text-green-600 transition-colors duration-300">Portfolio Site</h2>
          <p className="text-gray-700 group-hover:text-green-800 transition-colors duration-300">
